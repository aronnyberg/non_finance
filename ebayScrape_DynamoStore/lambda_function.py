#following has been uploaded to Lambda and operates correctly, dumps data into Dynamo table
# dependencies built using the following tutorial https://dev.to/aissalaribi/how-to-use-beautiful-soup-in-aws-lambda-for-web-scrapping-1gh8
...
def lambda_handler(event, context):
    dynamoDump()
    return f"Succeed! Find your new data file in testLambdarUN bucket :)"
